...
<section class="bg-gradient-to-r from-green-50 via-white to-green-50 pb-20 font-poppins">
    <div class="max-w-6xl mx-auto px-4">
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            @php
            $layanan = [
                ['img' => 'KS.jpg', 'title' => 'Penangkaran Bibit', 'desc' => 'Layanan penangkaran bibit pertanian, kehutanan dan hortikultura yang unggul dan bersertifikat.'],
                ['img' => 'KS.jpg', 'title' => 'Pengolahan Lahan & Panen', 'desc' => 'Mulai dari penyemaian, pembibitan, penanaman, pemeliharaan hingga pemanenan.'],
                ['img' => 'KS.jpg', 'title' => 'Supplier & Pengiriman', 'desc' => 'Pengiriman bibit dan barang ke berbagai daerah dengan armada dan layanan terpercaya.'],
                ['img' => 'KS.jpg', 'title' => 'Ekspedisi Barang & Jasa', 'desc' => 'Melayani pengangkutan dan ekspedisi barang secara cepat dan aman.'],
                ['img' => 'KS.jpg', 'title' => 'Kemitraan Proyek Reboisasi', 'desc' => 'Bermitra dalam proyek pemerintah & CSR reboisasi untuk pelestarian lingkungan.'],
                ['img' => 'KS.jpg', 'title' => 'Konsultasi & Pendampingan', 'desc' => 'Layanan konsultasi bibit, teknik tanam, dan pendampingan teknis oleh tenaga ahli.'],
            ];
            @endphp
