...
>
            ...
            <div class="flex items-center space-x-5 md:space-x-4">
                ...
                <div class="hidden md:flex absolute left-1/2 transform -translate-x-1/2 space-x-8 md:space-x-5 font-poppins font-normal">
                    ...
                    <div class="relative group">
                        <a href="{{ route('tentangkami.index') }}" wire:navigate
                            ...
                            Tentang Kami
                            <svg class="w-4 h-4 transform group-hover:rotate-180 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                        </a>

                        <!-- Dropdown Menu -->
                        <div class="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 scale-95 invisible group-hover:opacity-100 group-hover:scale-100 group-hover:visible transform transition-all duration-200 z-50">
                            <ul class="py-2 text-sm text-gray-700">
                                ...
                                <li>
                                    <a href="{{ route('tentangkami.visiMisi') }}" wire:navigate
                                ...
                                <li>
                                    <a href="{{ route('tentangkami.gallery') }}" wire:navigate
                    ...
                    <!-- Pengalaman -->
                    <a href="{{ route('experience.index') }}" wire:navigate
            ...
            <div class="flex items-center space-x-4 ml-auto">
                ...
                <div class="hidden md:flex items-center space-x-3 relative">
                    <div class="text-right">
                        <a href="https://wa.me/628126527016" target="_blank" rel="noopener noreferrer"
                    ...
                    <!-- Clock Dropdown -->
                    <div class="relative group">
                        <button type="button" class="text-gray-600 hover:text-green-700 focus:outline-none" aria-label="Jam Operasional">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white border rounded-md shadow-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                ...
                >
                    <svg x-show="!menuOpen" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                    </svg>

                    <svg x-show="menuOpen" x-cloak class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div 
        ...
        class="md:hidden w-full px-4 pt-4 pb-6 space-y-3 font-poppins text-sm bg-white border-t"
    >
        <a href="/" wire:navigate class="block text-gray-700 hover:bg-green-700 hover:text-white transition p-2 rounded-sm">Beranda</a>
        <a href="{{route('tentangkami.index')}}" wire:navigate class="block text-gray-700 hover:bg-green-700 hover:text-white transition p-2 rounded-sm">Tentang</a>
        <a href="{{route('produk')}}" wire:navigate class="block text-gray-700 hover:bg-green-700 hover:text-white transition p-2 rounded-sm">Produk</a>
        <a href="{{route('layanan')}}" wire:navigate class="block text-gray-700 hover:bg-green-700 hover:text-white transition p-2 rounded-sm">Layanan</a>
        <a href="{{route('experience.index')}}" wire:navigate class="block text-gray-700 hover:bg-green-700 hover:text-white transition p-2 rounded-sm">Pengalaman</a>
        <a href="{{route('contact')}}" wire:navigate class="block text-gray-700 hover:bg-green-700 hover:text-white transition p-2 rounded-sm">Kontak</a>

        <div class="border-t pt-3 mt-3">
            <a href="https://wa.me/628126527016" target="_blank" rel="noopener noreferrer" class="block text-green-700 hover:underline">+62 812 6527 016</a>
            <a href="mailto:karyasaginta@gmail.com" class="block text-green-700 mt-2 hover:underline">karyasaginta@gmail.com</a>
